...
@section('body')
      ...
      <section class="parallax-container overlay-1" data-parallax-img="images/breadcrumbs4.jpg">
                  ...
                  <div class="tab-pane fade show active" id="tabs-1-1">
                    ...
                    <div class="card bg-light" > {{-- CARD WITH IMAGE --}}
                      <div class="row no-gutters">
                        <div class="col-md-3">
                          <img src="images/product-1-370x395.jpg" class="card-img">
                        </div>
                        <div class="col-md-8">
                          <div class="card-body">
                  ...
                  <div class="tab-pane fade" id="tabs-1-2">
                    <div {{-- class="box-event-modern" --}}>
                      ...
                      <div class="card bg-light" > {{-- CARD WITH IMAGE --}}
                        <div class="row no-gutters">
                          <div class="col-md-3">
                            <img src="images/product-3-370x395.jpg" class="card-img">
                          </div>
                          <div class="col-md-8">
                            <div class="card-body">
                              <div class="event-item-modern">
