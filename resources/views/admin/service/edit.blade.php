                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="position-relative form-group">
                                    ...
                                    <input value="{{ $service->name }}" type="text" name="name" id="name" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="position-relative form-group">
                                    ...
                                    <input value="{{ $service->price }}" type="number" step="0.01" name="price" id="price" class="form-control" required>
                                </div>
                            </div>

                            <div class="col-md-3">
                                <div class="position-relative form-group">
                                    <label for="price" class="">Duracion <span class="text-danger">*</span></label>
                                    <input value="{{ $service->time }}" type="time" name="duration" id="duration" class="form-control" required>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="position-relative form-group">
                                    ...
                                    <input value="{{ $service->description }}" type="text" name="description" id="description" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="position-relative form-group">
                                    ...
                                    {{-- <input value="" type="select" name="description" id="description" class="form-control"> --}}
                                    <select name="type" id="type" class="form-control" required>
                                        @foreach ($productTypes as $type)
                                            <option value="{{ $type->id }}" @if($type->id == $service->type_id)selected="selected" @endif>{{ $type->name }}</option>
                                        @endforeach
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Eliminar producto {{ $service->name }}</h5>
            ...
            <div class="modal-footer">
                <form action="{{ route('admin.services.destroy', $service) }}" method="POST" style="margin-block-end: 0em;">
                    @csrf
                    @method('DELETE')
