                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h5 class="card-title mt-2">Listado de productos</h5>
                            </div>
                                ...
                                @else   
	                                ...
	                                <tr>
                                        ...
                                        <td class="text-center">
                                            @if ($product->stock == 0)
                                                <div class="badge badge-pill badge-danger">sin stock</div>
                                            @else
                                                {{ $product->stock }}
                                            @endif
                                        </td>
                                        ...
                                        @can('admin-gate')
                                            <td class="text-center">
                                                ...
                                                <a href="{{ route('admin.stock.edit', $product->id) }}" data-toggle="tooltip" 
